...
export default function TaskCard({ task, onAction, isCompleted = false, date = null }) {
    ...
    return (
        <div className={`group relative bg-slate-900 border rounded-2xl p-5 transition-all duration-300 ${isCompleted ? 'opacity-50' : ''} border-slate-800 hover:border-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/5`}>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
                ...
                <span className="ml-auto font-semibold text-white flex items-end gap-1">
                    <svg className="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <p>{task.estimate_hours}h</p>
                </span>
            </div>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-slate-800/50">
                <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-sm font-semibold transition-all ${isCompleted
                ...
                <button
                    ...
                    className="p-1.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 rounded-xl hover:bg-indigo-600 hover:text-white transition-all group/btn"
                ...
                <button
                    ...
                    className="p-1.5 bg-slate-800 text-slate-400 border border-slate-700 rounded-xl hover:bg-slate-700 hover:text-white transition-all"
                    title="Edit Task"
                >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
